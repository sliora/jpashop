...
public class OrderApiController {
    ...
    public List<OrdersDto> ordersV2() {
        ...
        List<OrdersDto> collect = getOrders.stream().map(o -> new OrdersDto(o)).collect(toList());
        return collect;
    }
    ...
    static class OrdersDto {
        ...
        public OrdersDto(Orders orders) {
            ...
            this.orderItems = orders.getOrderItems().stream().map(o -> new OrderItemDto(o)).collect(toList());
